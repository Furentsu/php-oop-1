<?php 
   ...
   class Movie {
       ...
       function __construct($genre, $title, $producer, $cast, $description, $length, $releaseDate) {
            $this->genre = $genre;
            $this->title = $title;
